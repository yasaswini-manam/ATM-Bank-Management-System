...
import javax.swing.*;
import java.sql.*;
import javax.swing.ButtonGroup;  // Import ButtonGroup
...
public class Signup2 extends JFrame implements ActionListener {
    ...
    // Button groups for mutual exclusivity
    ...
    Signup2(String formno) {
        ...
        group1 = new ButtonGroup();  // For Senior Citizen
        group2 = new ButtonGroup();  // For Existing Account
        ...
        // Add the radio buttons to their respective ButtonGroups
        group1.add(r1);
        group1.add(r2);
        group2.add(r3);
        group2.add(r4);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Validate PAN (format: XXXXX1234X)
        ...
        if (!pan.matches(panPattern)) {
            ...
            return;  // Stop execution if PAN is invalid
        }

        // Validate Aadhar (12 digits)
        String aadharPattern = "^\\d{12}$";
        if (!aadhar.matches(aadharPattern)) {
            JOptionPane.showMessageDialog(null, "Please enter a valid Aadhar number (12 digits).");
            return;  // Stop execution if Aadhar is invalid
        }
